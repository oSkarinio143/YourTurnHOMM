package pl.oskarinio.yourturnhomm.infrastructure.database;
...
public class DatabaseController {
    ...
    public DatabaseController(DatabaseUseCase databaseService, ExceptionMessageCreator exceptionHandlerService) {
