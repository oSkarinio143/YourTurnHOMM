...
import pl.oskarinio.yourturnhomm.domain.battle.model.AttackInfo;
import pl.oskarinio.yourturnhomm.domain.battle.model.BattleUnit;
...
public class BattleService {
    ...
    public BattleService(QueueUseCase queueUseCase, double atkRate, double defRate) {
